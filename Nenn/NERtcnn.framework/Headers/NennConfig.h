...
#define NENN_ERROR(format, ...) __android_log_print(ANDROID_LOG_ERROR, "NENNJNI", format, ##__VA_ARGS__)
#define NENN_PRINT(format, ...) __android_log_print(ANDROID_LOG_INFO, "NENNJNI", format, ##__VA_ARGS__)
#else
