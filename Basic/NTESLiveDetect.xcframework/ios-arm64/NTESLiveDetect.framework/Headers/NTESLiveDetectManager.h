 ...
 *               NTESLDCameraNotSupport     App相机不可用
 *
 *
 */
...
/**
 ...
 @param shakeThreshold 请传入0.01-0.1范围内的值，默认0.05
 */
- (void)setShakeThreshold:(CGFloat)shakeThreshold;

/**
 是否允许多人脸
 @param allowMultipleFace 默认 false，不允许多张人脸
 */
